...
async function GetVNo(Vtype) {
    ...
    try {
        ...
        const res = await fetch(
            `/InventoryTransferRequest/GetVNo?Vtype=${encodeURIComponent(Vtype)}`
        );
...
function AddRow(data = {}) {
    ...
    let newRow = `
        <tr class="no-border-input">
            ...
            <td>
                <input  class="erppagetable-control ItemCode" value="${data.itemCode ?? ''}" />
            </td>
            ...
            <td>
                <select class="erppagetable-control machinename">
