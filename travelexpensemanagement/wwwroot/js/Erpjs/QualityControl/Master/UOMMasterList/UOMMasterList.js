...
function deleteUOM(docId) {
    ...
    $.ajax({
        url: `/UOMMaster/IsQcUOMDeletable`,
        type: 'GET',
        data: { docId: docId },
        ...
        success: function (response) {
            ...
            let swalText = "This will permanently delete the QC Unit.";
            let cancelBtn = true;
            let confirmBtn = true;
