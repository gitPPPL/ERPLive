    ...
    const row = `
                <tr class="no-border-input">
                       ...
                       <td>
                        ...
                        <td class="td-status"><input type="text" class="erppagetable-control status" value="${data.status || 0}"/></td>
