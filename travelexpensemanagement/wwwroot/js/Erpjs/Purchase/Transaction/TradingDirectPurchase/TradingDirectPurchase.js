...
function bindHeaderEvents() {
    ...
    $('#TxtMRNNo2').on('change', function () {
        ...
        $.ajax({
            url: "/TradingDirectPurchase/ValidateMRN",
            type: "POST",
            data: {
                mrnTypeNo: mrnTypeNo,
    ...
    $('#TxtBankRate2').on('change', async function () {
        ...
        if (
            ...
            const response = await $.ajax({
                url: '/TradingDirectPurchase/GetNextPLNo',
                type: 'GET'
            });
            if (response.success) {
...
function bindAddressChange({ addressSelector, partySelector, add1Selector, add2Selector, add3Selector, gstSelector, pincodeSelector, citySelector }) {
    $(addressSelector).on('change', async function () {
        ...
        try {
            const response = await $.ajax({
                url: '/TradingDirectPurchase/GetAddressByBillToParty',
                type: 'GET',
                data: {
                    code,
                    addressId
...
async function GetVNo(vType) {
    try {
        const res = await fetch(`/TradingDirectPurchase/GetVNo?vType=${encodeURIComponent(vType)}`);
...
function loadMRNList(selectedValue = null) {
    ...
    return $.ajax({
        url: "/TradingDirectPurchase/GetMrnNoList",
        type: "GET",
        dataType: "json"
    }).then(response => {
...
async function loadDropdown(type, selector, data = {}, selectedValue = null) {
    ...
    // --------------------------------------------------------
    const promise = $.ajax({
        url: "/TradingDirectPurchase/GetList",
        type: "GET",
        data: {
            type,
            ...data
...
async function loadFullQuotationByVno(vNo, vType) {
    ...
    try {
        ...
        const response = await $.ajax({
            url: "/TradingDirectPurchase/GetFullQuotationByVno",
            type: "GET",
            dataType: "json",
...
async function LoadMRNData(vType, vNo) {
    $.ajax({
        url: '/TradingDirectPurchase/GetPurchaseDetailsByMRN',
        type: 'GET',
...
async function GetPurchaseItemsByMRN(vType, vNo) {
    ...
    try {
        const response = await $.ajax({
            url: '/TradingDirectPurchase/GetPurchaseItemsByMRN',
            type: 'GET',
            dataType: 'json',
            data: {
                vType,
...
function GetItemOrderRatesByPO(poType, poNo, itemCode) {
    ...
    return $.ajax({
        url: '/TradingDirectPurchase/GetItemOrderRatesByPO',
        type: 'GET',
        dataType: 'json',
        data: {
            poType: poType,
...
function GetPackOnBasic(code) {
    ...
    return $.ajax({
        url: '/TradingDirectPurchase/GetPackOnBasic',
        type: 'GET',
        dataType: 'json',
        data: {
            code: code
...
async function CalcDrCrNote() {
    ...
    try {
        const result = await $.ajax({
            url: "/TradingDirectPurchase/CalculateDebitNote",
            type: "POST",
...
async function CalcFreightAndCrDr(request) {
    try {
        ...
        const result = await $.ajax({
            url: "/TradingDirectPurchase/CalculateFrieght",
            type: "POST",
            contentType: "application/json",
            data: JSON.stringify(request)
        });
...
async function checkExistingTDS() {
    ...
    return await $.ajax({
        url: '/TradingDirectPurchase/CheckExistingTDS',
        type: 'POST',
        data: {
            billNo: billNo,
            drCode: drCode
...
function getFrtCrAcCodeByTransCode(transportCode) {
    ...
    $.ajax({
        url: '/TradingDirectPurchase/GetFrtCrAcByTransCode',
        type: 'GET',
        data: {
...
async function saveUpdateData() {
    ...
    if (rowsData.length === 0) {
        showToast("Please add at least one row before saving.", {type:"warning"});
        return;
    }
    ...
    //3. AJAX Save
    $.ajax({
        url: '/TradingDirectPurchase/SavePurchaseBillPassEntry',
        method: 'POST',
        contentType: 'application/json',
        ...
        success: function (response) {
            if (response.success) {
                ...
                setFormReadonly();
                isReadOnly = true;
                setTimeout(() => window.location.href = '/TradingDirectPurchase/Index?id=' + encodeURIComponent($('#NumDocNo').val()) + '&vtype=' + encodeURIComponent($('#ddlDocType').val()) + '&readOnly=true', 1000);
                if (isReadOnly) {
                    const vNo = $('#NumDocNo').val();
                    checkApprovalStatus(vType, vNo, DBTableName);
                }
            } else {
                showToast('Error: ' + response.message, {type:"error"});
            }
        },
        error: function (xhr, status, error) {
            showToast('AJAX error: ' + error, {type:"error"});
        }
    });
}
...
async function checkValidDate() {
    ...
    try {
        const response = await fetch('/TradingDirectPurchase/CheckValidDate', {
            method: 'POST',
            headers: {
...
async function validatePurchaseRow(vType, itemCode, itemName, billHsnCode,
    ...
    try {
        const response = await $.ajax({
            url: "/TradingDirectPurchase/ValidatePurchaseRow",
            type: "GET",
            dataType: "json",
            data: {
                vType: vType,
...
async function getPurchaseVoucherNo(transportName, grNo, currentVoucher, purchaseOrSale) {
    try {
        const response = await $.ajax({
            url: "/TradingDirectPurchase/GetPurchaseOrSaleVoucherNo",
            type: "GET",
            dataType: "json",
            data: {
...
async function checkPaymentExists(docType, docNo) {
    try {
        const response = await $.ajax({
            url: "/TradingDirectPurchase/CheckPaymentExists",
            type: "GET",
            dataType: "json",
            data: {
                docType: docType,
...
async function checkDuplicateBill(partyCode, billNo, currentVNo) {
    try {
        const response = await $.ajax({
            url: "/TradingDirectPurchase/CheckDuplicateBill",
            type: "GET",
            dataType: "json",
            data: {
                partyCode: partyCode,
...
async function validateTaxType(cityCode, totalIGST, totalCGST, totalSGST) {
    try {
        const response = await $.ajax({
            url: "/TradingDirectPurchase/ValidateTaxType",
            type: "GET",
            dataType: "json",
            data: {
                cityCode: cityCode,
...
async function validatePartyGst(gstType, partyCode, gstNo) {
    try {
        const response = await $.ajax({
            url: "/TradingDirectPurchase/ValidatePartyGst",
            type: "GET",
            dataType: "json",
            data: {
                gstType: gstType,
...
async function getGlobalValues() {
    try {
        const response = await $.ajax({
            url: "/TradingDirectPurchase/GetGlobalValues",
            type: "GET",
            dataType: "json"
        });
...
function GetCrDrNoteAmtForReport(vType, vNo, drOrCr) {
    return $.ajax({
        url: '/TradingDirectPurchase/GetCrDrNoteAmtForReport',
        type: 'GET',
        data: {
            vType: vType,
            vNo: vNo,
