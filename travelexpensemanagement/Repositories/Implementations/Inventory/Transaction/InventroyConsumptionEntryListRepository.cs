...
{
    public class InventroyConsumptionEntryListRepository : IInventroyConsumptionEntryListRepository
    {
        ...
        public InventroyConsumptionEntryListRepository(DataBaseConnection dbConnection, GlobalVariableService globalVariableService, ModuleService.ModuleService moduleService, travelexpensemanagement.LogService.LogService logService)
        {
