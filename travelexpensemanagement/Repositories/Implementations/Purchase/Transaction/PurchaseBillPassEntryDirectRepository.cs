...
namespace travelexpensemanagement.Repositories.Implementations.Purchase.Transaction
{
    ...
    public class PurchaseBillPassEntryDirectRepository : IPurchaseBillPassEntryDirectRepository
    {
        private readonly GlobalVariableService _globalVariableService;
        private readonly DataBaseConnection _dbConnection;
        private readonly DbHelper _dbHelper;
        public PurchaseBillPassEntryDirectRepository(DataBaseConnection dbConnection, GlobalVariableService globalVariableService, DbHelper dbHelper)
        {
        ...
        public async Task<PurchaseDetailsDto> GetPurchaseDetailsByMRN(string vType, int vNo)
        {
            ...
            using (SqlConnection con = _dbConnection.GetErpConnection())
            {
                ...
                if (isexist)
                {
                    string qry = $@"Select a.EXRATE as EXCH_RATE, a.PARTY_CODE, b.NAME 'BillTo', b.ADD1 as BILL_ADD1, b.ADD2 as BILL_ADD2, b.ADD3 as BILL_ADD3, 
                                    b.city_Code as BILL_CITY, b.GSTIN as BILL_GST, a.SHIP_FROM as SHIP_CODE, c.NAME 'ShipFrom', c.ADD1 as SHIP_ADD1,
                                    c.ADD2 as SHIP_ADD2, c.ADD3 as SHIP_ADD3,
                                    c.city_Code as SHIP_CITY, c.GSTIN as SHIP_GST, a.REMARKS 
                                    from ORDER1 a 
