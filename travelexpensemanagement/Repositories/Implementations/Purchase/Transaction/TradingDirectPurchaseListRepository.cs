...
{
    public class TradingDirectPurchaseListRepository : ITradingDirectPurchaseListRepository
    {
        private readonly GlobalVariableService _globalVariableService;
        private readonly DataBaseConnection _dbConnection;

        public TradingDirectPurchaseListRepository(GlobalVariableService globalVariableService, DataBaseConnection dbConnection)
        {
            ...
            try
            {
                using (SqlConnection conn = _dbConnection.GetErpConnection())
                {
                    using (SqlCommand cmd = new SqlCommand("sp_PurchaseBillPassEntryDirect", conn))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@Doctype", "TradingPurchase");
