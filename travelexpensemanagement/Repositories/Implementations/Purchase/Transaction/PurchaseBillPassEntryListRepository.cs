...
{
    public class PurchaseBillPassEntryListRepository : IPurchaseBillPassEntryListRepository
    {
        private readonly GlobalVariableService _globalVariableService;
        private readonly DataBaseConnection _dbConnection;

        public PurchaseBillPassEntryListRepository(GlobalVariableService globalVariableService, DataBaseConnection dbConnection)
        {
            ...
            try
            {
                using (SqlConnection conn = _dbConnection.GetErpConnection())
                {
                    using (SqlCommand cmd = new SqlCommand("sp_PurchaseBillPassEntryDirect", conn))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@Doctype", "Purchaseinvoice");
