...
namespace travelexpensemanagement.Repositories.Implementations.QualityControl
{
    ...
    public class FlakesQCEntryExcluListRepository : IFlakesQCEntryExcluListRepository
    {
        ...
        public FlakesQCEntryExcluListRepository(  DataBaseConnection dbConnection, GlobalVariableService globalVariableService,  GlobalValidationdate globalValidationdate)
        {
        ...
        public async Task<object> DocDetailsCode(string docCode)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("sp_FlexQCEntryExcru", conn))
                {
        ...
        public async Task<bool> Delete(int code)
        {
            try
            {
                ...
                using SqlCommand cmd = new("sp_FlexQCEntryExcru", con);
