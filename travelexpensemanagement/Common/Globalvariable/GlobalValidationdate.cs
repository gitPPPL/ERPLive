...
namespace travelexpensemanagement.Common.Globalvariable
{
    public class GlobalValidationdate
    {
        ...
        public GlobalValidationdate(DataBaseConnection dbConnection, GlobalVariableService globalVariableService, ModuleService.ModuleService moduleService, IConfiguration configuration)
        {
