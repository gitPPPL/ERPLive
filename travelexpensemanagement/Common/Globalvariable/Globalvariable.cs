...
namespace travelexpensemanagement.Common.Globalvariable
{
    public class GlobalVariableService
    {
        ...
        public async Task<GlobalGeneralSettingModel> LoadGeneralSetting()
        {
            ...
            {
                string qry = @"
                SELECT  a.* ,b.*,c.*,d.*,E.*,F.* FROM SYS_BP a
                ...
                LEFT JOIN SYS_SMS f ON a.COMP_CODE = f.COMP_CODE  AND f.ACTIVE = 1
                    ...
                    using (SqlCommand cmd = new SqlCommand(qry, con))
                    {
                        ...
                        using (SqlDataReader rdr = await cmd.ExecuteReaderAsync())
                        {
                            if (await rdr.ReadAsync())
                            {
                                ...
                                model.pubCrLimit = rdr["CR_LIMIT"] != DBNull.Value ? Convert.ToInt32(rdr["CR_LIMIT"]) : 0;
                                model.pubCrLimitSale = rdr["CR_LIMIT_SALE"] != DBNull.Value ? Convert.ToInt32(rdr["CR_LIMIT_SALE"]) : 0;
                                model.pubCrLimitOrder = rdr["CR_LIMIT_ORDER"] != DBNull.Value ? Convert.ToInt32(rdr["CR_LIMIT_ORDER"]) : 0;
                                model.pubCrLimitPack = rdr["CR_LIMIT_PACK"] != DBNull.Value ? Convert.ToInt32(rdr["CR_LIMIT_PACK"]) : 0;
                                model.pubPaytermCust = rdr["PAYTERM_CUST"] != DBNull.Value ? Convert.ToInt32(rdr["PAYTERM_CUST"]) : 0;
                                model.pubPaytermSupp = rdr["PAYTERM_SUPP"] != DBNull.Value ? Convert.ToInt32(rdr["PAYTERM_SUPP"]) : 0;
                                model.pubDefTDSGroup = rdr["TDS_ACGRP"] != DBNull.Value ? Convert.ToInt32(rdr["TDS_ACGRP"]) : 0;
                                model.pubDefCashAct = rdr["CASH_AC"] != DBNull.Value ? Convert.ToInt32(rdr["CASH_AC"]) : 0;

                                model.pubDispInactiveTran = rdr["DISP_INACTIVE_TRAN"] != DBNull.Value ? Convert.ToInt32(rdr["DISP_INACTIVE_TRAN"]) : 0;
                                model.pubDispInactiveReport = rdr["DISP_INACTIVE_REP"] != DBNull.Value ? Convert.ToInt32(rdr["DISP_INACTIVE_REP"]) : 0;
                                model.pubBPAllowInPurSale = rdr["BP_ALLOW_PURCH_SALE"] != DBNull.Value ? Convert.ToInt32(rdr["BP_ALLOW_PURCH_SALE"]) : 0;                                                     
                                ...
                                model.pubBPInsuPer = rdr["INSU_PER"] != DBNull.Value ? Convert.ToInt32(rdr["INSU_PER"]) : 0;
                                model.pubBPTCSPer = rdr["TCS_PER"] != DBNull.Value ? Convert.ToInt32(rdr["TCS_PER"]) : 0;
                                model.pubBPTotTCSSaleAmt = rdr["TCS_TOTSALEAMT"] != DBNull.Value ? Convert.ToInt32(rdr["TCS_TOTSALEAMT"]) : 0;
                                model.pubDefRCMConsigneeCode = rdr["RCM_CONSIGNEE"] != DBNull.Value ? Convert.ToInt32(rdr["RCM_CONSIGNEE"]) : 0;
                                ...
                                model.pubDecimalAmt = rdr["DECIMAL_AMT"] != DBNull.Value ? Convert.ToInt32(rdr["DECIMAL_AMT"]) : 0;

                                model.pubDecimalRate = rdr["DECIMAL_RATE"] != DBNull.Value ? Convert.ToInt32(rdr["DECIMAL_RATE"]) : 0;
                                model.pubDecimalQty = rdr["DECIMAL_QTY"] != DBNull.Value ? Convert.ToInt32(rdr["DECIMAL_QTY"]) : 0;
                                model.pubDecimalPrec = rdr["DECIMAL_PERC"] != DBNull.Value ? Convert.ToInt32(rdr["DECIMAL_PERC"]) : 0;
                                          

                                model.pubThousandSep = Convert.ToString(rdr["THOUS_SEP"]);

                                model.pubLanguageCode = rdr["LANGUAGE_CODE"] != DBNull.Value ? Convert.ToInt32(rdr["LANGUAGE_CODE"]) : 0;
                                ...
                                model.pubFontSize = rdr["FONT_SIZE"] != DBNull.Value ? Convert.ToInt32(rdr["FONT_SIZE"]) : 0;
                                model.pubFontBold = rdr["FONT_BOLD"] != DBNull.Value ? Convert.ToInt32(rdr["FONT_BOLD"]) : 0;
                                ...
                                model.pubEXRateScr = rdr["EX_RATE_SCR"] != DBNull.Value ? Convert.ToInt32(rdr["EX_RATE_SCR"]) : 0;
                                model.pubAutoAlerts = rdr["AUTO_ALERTS"] != DBNull.Value ? Convert.ToInt32(rdr["AUTO_ALERTS"]) : 0;
                                model.pubAutoMsg = rdr["AUTO_MSG"] != DBNull.Value ? Convert.ToInt32(rdr["AUTO_MSG"]) : 0;
                                model.pubAutoMail = rdr["AUTO_MAIL"] != DBNull.Value ? Convert.ToInt32(rdr["AUTO_MAIL"]) : 0;
                                model.pubAutoSMS = rdr["AUTO_SMS"] != DBNull.Value ? Convert.ToInt32(rdr["AUTO_SMS"]) : 0;                                                        
                                ...
                                model.pubAutoInbox = rdr["AUTO_INBOX"] != DBNull.Value ? Convert.ToInt32(rdr["AUTO_INBOX"]) : 0;
                                model.pubAutoTask = rdr["AUTO_TASK"] != DBNull.Value ? Convert.ToInt32(rdr["AUTO_TASK"]) : 0;
                                model.pubMsgUpdate = rdr["MSG_UPDATE"] != DBNull.Value ? Convert.ToInt32(rdr["MSG_UPDATE"]) : 0;
                                model.pubCaseSens = rdr["CASE_SENS"] != DBNull.Value ? Convert.ToInt32(rdr["CASE_SENS"]) : 0;
         
                                model.pubManageBatchBy = Convert.ToString(rdr["MANAGE_BATCHBY"]);


                                model.pubModifyDays = rdr["MODIFY_DAYS"] != DBNull.Value ? Convert.ToInt32(rdr["MODIFY_DAYS"]) : 0;
                                model.pubMaxRequestInADay = rdr["MAX_REQUEST"] != DBNull.Value ? Convert.ToInt32(rdr["MAX_REQUEST"]) : 0;
                                model.pubApprovalSendDays = rdr["APPROVAL_SENDDAYS"] != DBNull.Value ? Convert.ToInt32(rdr["APPROVAL_SENDDAYS"]) : 0;                       
                                model.pubWBUser = rdr["WB_USER"] != DBNull.Value ? Convert.ToInt32(rdr["WB_USER"]) : 0;                       
                                model.pubTimer1 = rdr["T1"] != DBNull.Value ? Convert.ToInt32(rdr["T1"]) : 0;                       
                                model.pubTimer2 = rdr["T2"] != DBNull.Value ? Convert.ToInt32(rdr["T2"]) : 0;                       
                                model.pubInterval2 = rdr["INT2"] != DBNull.Value ? Convert.ToInt32(rdr["INT2"]) : 0;                       
                                model.pubTimer3 = rdr["T3"] != DBNull.Value ? Convert.ToInt32(rdr["T3"]) : 0;                       
                                model.pubInterval3 = rdr["INT3"] != DBNull.Value ? Convert.ToInt32(rdr["INT3"]) : 0;                       
                                model.pubZoomLevel = rdr["ZOOM_LEVEL"] != DBNull.Value ? Convert.ToInt32(rdr["ZOOM_LEVEL"]) : 0;                       
                                model.pubDefOnlyform12 = rdr["ONLY_FORM12"] != DBNull.Value ? Convert.ToInt32(rdr["ONLY_FORM12"]) : 0;                       
                                model.pubDefWBWOImage = rdr["WBWOIMAGE"] != DBNull.Value ? Convert.ToInt32(rdr["WBWOIMAGE"]) : 0;                       
                                model.pubDefPreQcNos = rdr["NOS_PREQC"] != DBNull.Value ? Convert.ToInt32(rdr["NOS_PREQC"]) : 0;



                                // EInvoice
                                if (rdr["EINV_LIVECONFIG"] != DBNull.Value && Convert.ToInt32(rdr["EINV_LIVECONFIG"]) == 1)
                                {
                                    model.PubEinvFLG = 1;
                                ...
                                model.pubignoreRCMAct = rdr["IGNORE_FRTRCMACT"] != DBNull.Value ? Convert.ToInt32(rdr["IGNORE_FRTRCMACT"]) : 0;
