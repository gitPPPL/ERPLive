...
{
    public SalesInvoiceModel_Header Header { get; set; } = new();
    public List<SalesInvoiceModel_Detail> Details { get; set; } = new();
}

public class SalesInvoiceModel_Header
{
...
public class SalesInvoiceModel_Detail
{
    public decimal? AMOUNT { get; set; }
    public decimal? CDISC_AMT { get; set; }
    public decimal? CESS_AMT { get; set; }
