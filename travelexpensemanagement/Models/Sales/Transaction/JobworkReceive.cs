public class JobworkReceive
{
    public JobFormDataModel FormData { get; set; }
    public List<JobRowDataModel> RowData { get; set; }
}

public class JobFormDataModel
{
    ...
    public string? NatureJW { get; set; }
...
public class JobworkReceiveModel
{
