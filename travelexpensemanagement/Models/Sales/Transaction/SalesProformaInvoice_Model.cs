...
public class SalesProformaInvoice_Model
{
    public SalesProformaInvoice_Header Header { get; set; } = new();
    public List<SalesProformaInvoice_Detail> RowData { get; set; } = new();
}

public class SalesProformaInvoice_Header
{

    public string V_TYPE { get; set; } = string.Empty;
