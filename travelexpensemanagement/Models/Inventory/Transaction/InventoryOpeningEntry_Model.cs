...
{
    public class InventoryOpeningEntry_Model
    {
        public InventoryOpeningEntry_Header Header { get; set; }
        public List<InventoryOpeningEntry_Details> Details { get; set; } 
    }

    public class InventoryOpeningEntry_Header
    {
