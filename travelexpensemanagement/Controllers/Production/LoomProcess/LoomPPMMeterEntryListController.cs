...
{
    public class LoomPPMMeterEntryListController : Controller
    {
        ...
        public LoomPPMMeterEntryListController(DataBaseConnection dbConnection, GlobalVariableService globalVariableService,
     ...
     ModuleService.ModuleService moduleService)
        ...
        {
            ViewBag.CurrentMenu = "Loom PPMMeter Entry";
            ...
            return View("~/Views/Production/LoomProcess/LoomPPMMeterEntryList/Index.cshtml", model);
        }
        ...
        public IActionResult loadListData(int pageNumber = 1, int pageSize = 10, string searchTerm = "")
        {
            ...
            try
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("sp_LoomPPM_MeterEntry", con);
                    ...
                    cmd.Parameters.AddWithValue("@V_TYPE", "LMPM");
