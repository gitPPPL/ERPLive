...
using travelexpensemanagement.Models.Production.SemiFinishedGoods.DepartmentIssue;

namespace travelexpensemanagement.Controllers.Production.SemiFinishedGoods
{
    public class DepartmentIssueController : Controller
    {
        ...
        public DepartmentIssueController(DataBaseConnection dbConnection, GlobalVariableService globalVariableService,
     ...
     ModuleService.ModuleService moduleService)
        ...
        {
            return View("~/Views/Production/SemiFinishedGoods/DepartmentIssue/Index.cshtml");
        }
        ...
        public IActionResult DOCTYPE()
        {
            ...
            string query = "Select Code,Name from DOCTYPE_MAST where CODE in ('RMAI')";
        ...
        [HttpPost]
        public IActionResult SaveData([FromBody] DepartmentIssue model)
        {
            if (model == null)
            {
            ...
            try
            {
                ...
                using (SqlConnection con = _dbConnection.GetErpConnection())
                {
                    ...
                    try
                    {
                        SqlCommand cmd = new SqlCommand("sp_Department_Issue", con, trans);
                        ...
                        {
                            SqlCommand cmdItem = new SqlCommand("sp_Department_Issue", con, trans);
