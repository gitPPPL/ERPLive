...
{
    public class ReceiptAfterProductionEntryListController : Controller
    {
        ...
        public ReceiptAfterProductionEntryListController(DataBaseConnection dbConnection, GlobalVariableService globalVariableService,
     ...
     ModuleService.ModuleService moduleService)
        ...
        public IActionResult Index()
        {
            ...
            return View("~/Views/Production/SemiFinishedGoods/ReceiptAfterProductionEntryList/Index.cshtml", model);
        }
        ...
        public IActionResult loadListData(int pageNumber = 1, int pageSize = 10, string searchTerm = "")
        {
            ...
            try
            {
                using(SqlConnection con = _dbConnection.GetErpConnection())
                {
                    ...
                    cmd.Parameters.AddWithValue("@V_TYPE", "PRDR");
