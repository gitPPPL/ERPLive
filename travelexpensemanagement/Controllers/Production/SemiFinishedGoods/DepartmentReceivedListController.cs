...
{
    public class DepartmentReceivedListController : Controller
    {
        ...
        public DepartmentReceivedListController(DataBaseConnection dbConnection, GlobalVariableService globalVariableService,
     ...
     ModuleService.ModuleService moduleService)
        ...
        {
            ViewBag.CurrentMenu = "Department Received";
            ...
            return View("~/Views/Production/SemiFinishedGoods/DepartmentReceivedList/Index.cshtml", model);
        }
        ...
        public IActionResult loadListData(int pageNumber = 1, int pageSize = 10, string searchTerm = "")
        {
            ...
            try
            {
                using (SqlConnection con = _dbConnection.GetErpConnection())
                {
                    ...
                    cmd.Parameters.AddWithValue("@V_TYPE", "RMAR");
