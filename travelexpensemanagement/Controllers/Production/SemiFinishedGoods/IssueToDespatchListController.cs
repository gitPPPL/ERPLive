...
{
    public class IssueToDespatchListController : Controller
    {
        ...
        public IssueToDespatchListController(DataBaseConnection dbConnection, GlobalVariableService globalVariableService,
     ...
     ModuleService.ModuleService moduleService)
        ...
        {
            ViewBag.CurrentMenu = "Receipt After Production Entry";
            ...
            return View("~/Views/Production/SemiFinishedGoods/IssueToDespatchList/Index.cshtml", model);
        }
        ...
        public IActionResult loadListData(int pageNumber = 1, int pageSize = 10, string searchTerm = "")
        {
            ...
            try
            {
                using (SqlConnection con = _dbConnection.GetErpConnection())
                {
                    ...
                    cmd.Parameters.AddWithValue("@V_TYPE", "RAID");
