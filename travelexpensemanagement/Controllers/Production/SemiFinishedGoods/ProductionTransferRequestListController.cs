...
{
    public class ProductionTransferRequestListController : Controller
    {
        ...
        public ProductionTransferRequestListController(DataBaseConnection dbConnection, GlobalVariableService globalVariableService,
     ...
     ModuleService.ModuleService moduleService)
        ...
        {
            ViewBag.CurrentMenu = "Production Transfer Request";
            ...
            return View("~/Views/Production/SemiFinishedGoods/ProductionTransferRequestList/Index.cshtml", model);
        }
