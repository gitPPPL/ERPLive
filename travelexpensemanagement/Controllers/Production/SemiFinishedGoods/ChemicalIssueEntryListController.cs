...
{
    public class ChemicalIssueEntryListController : Controller
    {
        ...
        public ChemicalIssueEntryListController(DataBaseConnection dbConnection, GlobalVariableService globalVariableService,
     ...
     ModuleService.ModuleService moduleService)
        ...
        {
            ViewBag.CurrentMenu = "Chemical Issue Entry";
            ...
            return View("~/Views/Production/SemiFinishedGoods/ChemicalIssueEntryList/Index.cshtml", model);
        }
        ...
        public IActionResult loadListData(int pageNumber = 1, int pageSize = 10, string searchTerm = "")
        {
            ...
            try
            {
                using (SqlConnection con = _dbConnection.GetErpConnection())
                {
                    ...
                    cmd.Parameters.AddWithValue("@V_TYPE", "CMIS");
