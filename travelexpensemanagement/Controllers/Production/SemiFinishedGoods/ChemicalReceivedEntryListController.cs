...
{
    public class ChemicalReceivedEntryListController : Controller
    {
        ...
        public ChemicalReceivedEntryListController(DataBaseConnection dbConnection, GlobalVariableService globalVariableService,
     ...
     ModuleService.ModuleService moduleService)
        ...
        {
            ViewBag.CurrentMenu = "Chemical Received Entry";
            ...
            return View("~/Views/Production/SemiFinishedGoods/ChemicalReceivedEntryList/Index.cshtml", model);
        }
        ...
        public IActionResult loadListData(int pageNumber = 1, int pageSize = 10, string searchTerm = "")
        {
            ...
            try
            {
                using (SqlConnection con = _dbConnection.GetErpConnection())
                {
                    ...
                    cmd.Parameters.AddWithValue("@V_TYPE", "CMRC");
