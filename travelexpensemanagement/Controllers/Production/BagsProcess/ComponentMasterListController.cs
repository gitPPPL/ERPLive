...
{
    public class ComponentMasterListController : Controller
    {
        ...
        public ComponentMasterListController(DataBaseConnection dbConnection, GlobalVariableService globalVariableService,
     ...
     ModuleService.ModuleService moduleService)
        ...
        {
            ViewBag.CurrentMenu = "Component Master";
            ...
            return View("~/Views/Production/BagsProcess/ComponentMasterList/Index.cshtml", model);
        }
