...
using travelexpensemanagement.Models.Production.BagsProcess.StichingMaster;

namespace travelexpensemanagement.Controllers.Production.BagsProcess
{
    public class StichingMasterController : Controller
    {
        ...
        public StichingMasterController(DataBaseConnection dbConnection, GlobalVariableService globalVariableService,
     ...
     ModuleService.ModuleService moduleService)
        ...
        {
            return View("~/Views/Production/BagsProcess/StichingMaster/Index.cshtml");
        }

        [HttpPost]
        public IActionResult SaveAndUpdateData([FromBody] StichingMaster model)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("sp_Stiching_Master", con);
