...
using travelexpensemanagement.Models.Production.BagsProcess.LinerTypeMaster;

namespace travelexpensemanagement.Controllers.Production.BagsProcess
{
    public class LinerTypeMasterController : Controller
    {
        ...
        public LinerTypeMasterController(DataBaseConnection dbConnection, GlobalVariableService globalVariableService,
     ...
     ModuleService.ModuleService moduleService)
        ...
        {
            return View("~/Views/Production/BagsProcess/LinerTypeMaster/Index.cshtml");
        }

        [HttpPost]
        public IActionResult SaveAndUpdateData([FromBody] LinerTypeMaster model)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("sp_LinerType_Master", con);
