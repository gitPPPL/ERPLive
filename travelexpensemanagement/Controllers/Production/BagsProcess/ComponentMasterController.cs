...
using travelexpensemanagement.Models.Production.BagsProcess.ComponentMaster;
...
namespace travelexpensemanagement.Controllers.Production.BagsProcess
{
    public class ComponentMasterController : Controller
    {
        ...
        public ComponentMasterController(DataBaseConnection dbConnection, GlobalVariableService globalVariableService,
     ...
     ModuleService.ModuleService moduleService)
        ...
        {
            return View("~/Views/Production/BagsProcess/ComponentMaster/Index.cshtml");
        }

        [HttpPost]
        public IActionResult SaveAndUpdateData([FromBody] ComponentMaster model)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("sp_ComponentMaster", con);
