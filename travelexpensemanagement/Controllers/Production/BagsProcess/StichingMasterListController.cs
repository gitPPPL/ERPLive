...
{
    public class StichingMasterListController : Controller
    {
        ...
        public StichingMasterListController(DataBaseConnection dbConnection, GlobalVariableService globalVariableService,
     ...
     ModuleService.ModuleService moduleService)
        ...
        public IActionResult Index()
        {
            ...
            return View("~/Views/Production/BagsProcess/StichingMasterList/Index.cshtml", model);
        }
