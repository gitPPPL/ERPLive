...
{
    public class LinerTypeMasterListController : Controller
    {
        ...
        public LinerTypeMasterListController(DataBaseConnection dbConnection, GlobalVariableService globalVariableService,
     ...
     ModuleService.ModuleService moduleService)
        ...
        {
            ViewBag.CurrentMenu = "Liner Type Master";
            ...
            return View("~/Views/Production/BagsProcess/LinerTypeMasterList/Index.cshtml", model);
        }
