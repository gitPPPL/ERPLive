...
namespace travelexpensemanagement.Controllers.PlantMaintenance.Master
{
    public class PMCheckListMasterListController : Controller
    {
        ...
        public PMCheckListMasterListController(DataBaseConnection dbConnection, travelexpensemanagement.Common.DbHelper.DbHelper dbHelper, GlobalVariableService globalVariableService, ModuleService.ModuleService moduleService)
        {
            _dbHelper = dbHelper;
