...
using travelexpensemanagement.Models.PlantMaintenance.Master.PMCategoryMaster;


namespace travelexpensemanagement.Controllers.PlantMaintenance.Master
{
    public class PmCategoryMasterController : Controller
    {
        ...
        public PmCategoryMasterController(DataBaseConnection dbConnection, GlobalVariableService globalVariableService,
     ...
     ModuleService.ModuleService moduleService)
        ...
        {
            return View("~/Views/PlantMaintenance/Master/PMCategoryMaster/Index.cshtml");
        }
        [HttpPost]
        public IActionResult SaveOrUpdateData([FromBody] PMCategoryMaster model)
        {
