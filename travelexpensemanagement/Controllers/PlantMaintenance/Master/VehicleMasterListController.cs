...
namespace travelexpensemanagement.Controllers.PlantMaintenance.Master
{
    public class VehicleMasterListController : Controller
    {
        ...
        public VehicleMasterListController(DataBaseConnection dbConnection, travelexpensemanagement.Common.DbHelper.DbHelper dbHelper, GlobalVariableService globalVariableService, ModuleService.ModuleService moduleService)
        {
            _dbHelper = dbHelper;
