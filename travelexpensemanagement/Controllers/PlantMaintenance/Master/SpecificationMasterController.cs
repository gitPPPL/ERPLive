...
using travelexpensemanagement.Models.PlantMaintenance.Master.SpecificationMaster;

namespace travelexpensemanagement.Controllers.PlantMaintenance.Master
{
    public class SpecificationMasterController : Controller
    {   private readonly DataBaseConnection _dbConnection;
        private readonly GlobalVariableService _globalVariableService;
        private readonly DropdownService _dropdownService;
        private readonly travelexpensemanagement.Common.DbHelper.DbHelper _dbHelper;
        private readonly travelexpensemanagement.ModuleService.ModuleService _moduleService;
        public SpecificationMasterController(DataBaseConnection dbConnection, GlobalVariableService globalVariableService,
     ...
     ModuleService.ModuleService moduleService)
        ...
        {
            return View("~/Views/PlantMaintenance/Master/SpecificationMaster/Index.cshtml");
        }
        [HttpPost]
        public IActionResult SaveOrUpdateData([FromBody] SpecificationMaster model)
        {
