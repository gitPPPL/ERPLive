...
namespace travelexpensemanagement.Controllers.Weighbridge.Transaction
{
    public class StoreWeighbridgeEntryListController : Controller
    {
        ...
        public StoreWeighbridgeEntryListController(DataBaseConnection dbcontext, travelexpensemanagement.DbHelper.DbHelper dbHelper, GlobalVariableService globalValue, ModuleService.ModuleService moduleService)
        {
            _dbHelper = dbHelper;
