...
namespace travelexpensemanagement.Controllers.Admin.SystemInitilization
{
    ...
    public class DocumentNumberingListController : Controller
    {
        ...
        public DocumentNumberingListController(DataBaseConnection dbcontext, travelexpensemanagement.DbHelper.DbHelper dbHelper, GlobalVariableService globalValue, ModuleService.ModuleService moduleService)
        {
            _dbHelper = dbHelper;
