...
{
    [SessionAuthorize]
    public class ToolkitissuelistController : Controller
    {
        ...
        public ToolkitissuelistController(GlobalVariableService globalVariableService, DataBaseConnection dbConnection
            , GlobalExcelExport excel, DbHelper dbHelper, GlobalValidationdate globalValidationdate, IToolkitIssueListRepository repository)
        {
        ...
        {
            return View("~/Views/Inventory/Transaction/ToolkitIssuelist/Index.cshtml");
        }
        ...
        public IActionResult ExportAllDocs()
        {
            try
            {
                ...
                var fileBytes = _excel.ExportToExcel("sp_ToolKitIssueEntry", "Toolkit Issue", parameters);

                return File(
                    fileBytes,
                    "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
                    $"ToolkitIssue_{DateTime.Now:ddMMyyyy}.xlsx"
                );
            }
            catch (Exception ex)
            {
