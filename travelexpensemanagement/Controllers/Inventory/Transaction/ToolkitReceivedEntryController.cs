...
namespace travelexpensemanagement.Controllers.Inventory.Transaction
{
    public class ToolkitReceivedEntryController : Controller
    {
        ...
        public ToolkitReceivedEntryController(DataBaseConnection dbConnection, GlobalVariableService globalVariableService, DbHelper dbHelper,
        ...
        {
            return View("~/Views/Inventory/Transaction/ToolkitReceivedEntry/Index.cshtml");
        }
