...
{
    public class SizeMasterListController : Controller
    {
        private readonly travelexpensemanagement.DbHelper.DbHelper _dbHelper;
        private readonly DataBaseConnection _dbcontext;
        private readonly GlobalVariableService _globalValue;
        string yearPrefix, VNO;
        public SizeMasterListController(DataBaseConnection dbcontext, travelexpensemanagement.DbHelper.DbHelper dbHelper, GlobalVariableService globalValue)
        {
            _dbHelper = dbHelper;
        ...
        {
            return View("~/Views/Inventory/Master/SizeMasterList/Index.cshtml");
        }


        [HttpGet]
        public async Task<IActionResult> GetSizeMastData(string searchTerm = "", int pageNumber = 1, int pageSize = 10)
        {
            try
            {
