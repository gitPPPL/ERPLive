...
namespace travelexpensemanagement.Controllers.Inventory.Master
{
    public class BinMasterController : Controller
    {
        ...
        public BinMasterController(DataBaseConnection dbConnection, GlobalVariableService globalVariableService,
  ...
  ModuleService.ModuleService moduleService)
        ...
        {
            return View("~/Views/Inventory/Master/BinMaster/Index.cshtml");
        }

        [HttpPost]
        public IActionResult SaveBinMaster([FromBody] BinMasterModel data)
        {
            if (data == null)
            {
        ...
        [HttpPost]
        private string Submitbtn(BinMasterModel data, string action)
        {
            try
            {
