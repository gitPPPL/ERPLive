...
namespace travelexpensemanagement.Controllers.QualityControl.Master
{
    public class ParameterMasterListController : Controller
    {
        ...
        public ParameterMasterListController(DataBaseConnection dbcontext, travelexpensemanagement.DbHelper.DbHelper dbHelper, GlobalVariableService globalValue)
        {
            _dbHelper = dbHelper;
