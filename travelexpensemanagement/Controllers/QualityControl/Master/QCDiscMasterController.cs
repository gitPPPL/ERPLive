...
namespace travelexpensemanagement.Controllers.QualityControl.Master
{
    public class QCDiscMasterController : Controller
    {
        ...
        private readonly IQCDiscMasterRepository _qcDiscMasterRepository;
        public QCDiscMasterController(DataBaseConnection dbConnection, GlobalVariableService globalVariableService,
        DropdownService dropdownService, DbHelper dbHelper, IQCDiscMasterRepository qcDiscMasterRepository, ModuleService.ModuleService moduleService)
        {
            ...
            _qcDiscMasterRepository = qcDiscMasterRepository;
        }
        ...
        public IActionResult SaveAndUpdateData([FromBody] QCDISC_MAST model)
        {
            try
            {
                _qcDiscMasterRepository.SaveAndUpdateData(model);
        ...
        public JsonResult GetQcDiscOnChange(int itemCode)
        {
            try
            {
                ...
                var result = _qcDiscMasterRepository.GetQcDiscOnChange(itemCode);
            ...
            catch (Exception ex)
            {
                ...
                {
                    success = false,
                    message = "Error fetching Qc discount",
                    error = ex.Message
                });
            }
        }
        ...
        public JsonResult DeleteQcDiscByCode(int code)
        {
            try
            {
                ...
                _qcDiscMasterRepository.DeleteQcDiscByCode(code);
        ...
        //            cmd.Parameters.AddWithValue("@EUSER", globalVaribales.PubUserId);
