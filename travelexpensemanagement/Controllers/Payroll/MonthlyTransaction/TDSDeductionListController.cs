...
namespace travelexpensemanagement.Controllers.Payroll.MonthlyTransaction
{
    public class TDSDeductionListController : Controller
    {
        ...
        public TDSDeductionListController(DataBaseConnection dbcontext, DbHelper dbHelper, GlobalVariableService globalValue, ModuleService.ModuleService moduleService)
        {
            _dbHelper = dbHelper;
