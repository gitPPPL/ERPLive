...
namespace travelexpensemanagement.Controllers.Payroll.MonthlyTransaction
{
    public class EmployeeIncrementListController : Controller
    {
        ...
        public EmployeeIncrementListController(DataBaseConnection dbcontext, travelexpensemanagement.DbHelper.DbHelper dbHelper, GlobalVariableService globalValue, ModuleService.ModuleService moduleService)
        {
            _dbHelper = dbHelper;
