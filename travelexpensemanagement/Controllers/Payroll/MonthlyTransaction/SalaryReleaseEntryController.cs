...
{
    public class SalaryReleaseEntryController : Controller
    {
        ...
        public SalaryReleaseEntryController(DataBaseConnection dbConnection, GlobalVariableService globalVariableService,
        ...
        {
            return View("~/Views/Payroll/MonthlyTransaction/SalaryReleaseEntry/Index.cshtml");
        }
        ...
        public JsonResult DDlDoctype()
        {
            ...
            {
                string query = "SELECT CODE, NAME FROM DOCTYPE_MAST  WHERE  DOCTYPE ='PayRelease'";
        ...
        public JsonResult GetVNo()
        {
            ...
            try
            {
                ...
                using (SqlConnection con = _dbConnection.GetErpConnection())
                {
                    ...
                    string lastV_NO_Query = "select max(V_no) from PAY_MESS where V_TYPE='PREL' and COMP_CODE= @CompCode and BRANCH_CODE= 1 and YEAR_CODE= @YearCode  ";
        ...
        [HttpPost]
        public IActionResult SaveData([FromBody] List<SalaryReleaseEntry_Model> data)
        {
            ...
            string loginDateStr = g.PubLoginDate.ToString("yyyy-MM-dd");
