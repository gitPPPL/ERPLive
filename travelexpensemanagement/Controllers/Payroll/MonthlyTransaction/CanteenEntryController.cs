...
{
    public class CanteenEntryController : Controller
    {
        ...
        public CanteenEntryController(DataBaseConnection dbConnection, GlobalVariableService globalVariableService,
        ...
        {
            return View("~/Views/Payroll/MonthlyTransaction/CanteenEntry/Index.cshtml");
        }
        ...
        public JsonResult DDlDoctype()
        {
            ...
            {
                string query = "SELECT CODE, NAME FROM DOCTYPE_MAST  WHERE  DOCTYPE ='PayMess'";
        ...
        public JsonResult GetVNo()
        {
            ...
            try
            {
                ...
                using (SqlConnection con = _dbConnection.GetErpConnection())
                {
                    ...
                    string lastV_NO_Query = "select max(V_no) from PAY_MESS where V_TYPE='MESS' and COMP_CODE= @CompCode and BRANCH_CODE= 1 and YEAR_CODE= @YearCode  ";
        ...
        [HttpPost]
        public IActionResult SaveData([FromBody] List<Canteen_Model> data)
        {
