...
{
    public class InstallmentModificationEntryController : Controller
    {
        ...
        public InstallmentModificationEntryController(DataBaseConnection dbConnection, GlobalVariableService globalVariableService,
        ...
        {
            return View("~/Views/Payroll/MonthlyTransaction/InstallmentModificationEntry/Index.cshtml");
        }
        ...
        public JsonResult DDlDoctype()
        {
            ...
            {
                string query = "SELECT CODE, NAME FROM DOCTYPE_MAST  WHERE  DOCTYPE ='PayInstallModify'";
        ...
        public JsonResult GetVNo()
        {
            ...
            try
            {
                ...
                using (SqlConnection con = _dbConnection.GetErpConnection())
                {
                    ...
                    string lastV_NO_Query = "select max(V_no) from PAY_MESS where V_TYPE='INSM' and COMP_CODE= @CompCode and BRANCH_CODE= 1 and YEAR_CODE= @YearCode  ";
        ...
        [HttpPost]
        public IActionResult SaveData([FromBody] List<InstallmentModificationEntry_model> data)
        {
            ...
            try
            {
                ...
                {
                    using (var cmd = new SqlCommand("sp_Canteen", conn))
                    {
