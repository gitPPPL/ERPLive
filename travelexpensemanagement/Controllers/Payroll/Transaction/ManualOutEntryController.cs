...
{
    public class ManualOutEntryController : Controller
    {
        ...
        public ManualOutEntryController(DataBaseConnection dbConnection, GlobalVariableService globalVariableService,
        ...
        {
            return View("~/Views/Payroll/Transaction/ManualOutEntry/Index.cshtml");
        }
        ...
        public JsonResult DDlDoctype()
        {
            ...
            using (SqlConnection con = _dbConnection.GetErpConnection())
            {
                string query = "SELECT CODE, NAME FROM DOCTYPE_MAST  WHERE Code in ('OUT', 'IN')";
        ...
        [HttpPost]
        public IActionResult SavedData([FromBody] PAY_INOUT Header)
        {
            if (Header == null)
        ...
        private string SubmitRequest(PAY_INOUT Header, string action)
        {
            try
            {
