...
namespace travelexpensemanagement.Controllers.Payroll.Transaction
{
    public class EmployeeGateOutListController : Controller
    {
        ...
        public EmployeeGateOutListController(DataBaseConnection dbcontext, DbHelper dbHelper, GlobalVariableService globalValue, ModuleService.ModuleService moduleService)
        {
            _dbHelper = dbHelper;
