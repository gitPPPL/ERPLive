...
namespace travelexpensemanagement.Controllers.Payroll.Master
{
    public class HolidayMasterListController : Controller
    {
        ...
        public HolidayMasterListController(DataBaseConnection dbcontext, DbHelper dbHelper, GlobalVariableService globalValue, ModuleService.ModuleService moduleService)
        {
            _dbHelper = dbHelper;
