...
namespace travelexpensemanagement.Controllers.Payroll.Master
{
    public class SalaryLevelMasterController : Controller
    {
        ...
        public SalaryLevelMasterController(DataBaseConnection dbcontext, DbHelper dbHelper, GlobalVariableService globalValue, ModuleService.ModuleService moduleService)
        {
            _dbHelper = dbHelper;
