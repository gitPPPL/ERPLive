...
namespace travelexpensemanagement.Controllers.Payroll.Master
{
    public class SalaryStructureMasterController : Controller
    {
        ...
        int x;
        public SalaryStructureMasterController(DataBaseConnection dbcontext, travelexpensemanagement.DbHelper.DbHelper dbHelper, GlobalVariableService globalValue)
        {
            _dbHelper = dbHelper;
