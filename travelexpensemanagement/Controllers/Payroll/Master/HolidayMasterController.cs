...
namespace travelexpensemanagement.Controllers.Payroll.Master
{
    public class HolidayMasterController : Controller
    {
        ...
        public HolidayMasterController(DataBaseConnection dbcontext, DbHelper dbHelper, GlobalVariableService globalValue, ModuleService.ModuleService moduleService)
        {
            _dbHelper = dbHelper;
