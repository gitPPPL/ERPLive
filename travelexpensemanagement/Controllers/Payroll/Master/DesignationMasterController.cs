...
namespace travelexpensemanagement.Controllers.Payroll.Master
{
    public class DesignationMasterController : Controller
    {
        ...
        public DesignationMasterController(DataBaseConnection dbcontext, travelexpensemanagement.DbHelper.DbHelper dbHelper, GlobalVariableService globalValue)
        {
            _dbHelper = dbHelper;
        ...
        {
            return View("~/Views/Payroll/Master/DesignationMaster/Index.cshtml");
        }
        ...
        [HttpPost]
        public async Task<IActionResult> SaveDesignationMast([FromBody] DesignationModel model)
        {
            try
            {
                if (model == null)
        ...
        [HttpGet]
        public async Task<IActionResult> GetDesignationDetailsById(string id)
        {
            try
            {
                string strqry = $@"
                select distinct CODE,NAME,SHORTNAME,ACTIVE  from DESG_MAST
        ...
        [HttpPost]
        public async Task<IActionResult> UpdateDesignationMast([FromBody] DesignationModel model)
        {
            try
            {
                if (model == null)
