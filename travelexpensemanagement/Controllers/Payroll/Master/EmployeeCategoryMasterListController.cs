...
namespace travelexpensemanagement.Controllers.Payroll.Master
{
    public class EmployeeCategoryMasterListController : Controller
    {
        ...
        public EmployeeCategoryMasterListController(DataBaseConnection dbcontext, DbHelper dbHelper, GlobalVariableService globalValue, ModuleService.ModuleService moduleService)
        {
            _dbHelper = dbHelper;
