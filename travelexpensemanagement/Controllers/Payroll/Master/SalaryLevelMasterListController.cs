...
namespace travelexpensemanagement.Controllers.Payroll.Master
{
    public class SalaryLevelMasterListController : Controller
    {
        ...
        public SalaryLevelMasterListController(DataBaseConnection dbcontext, travelexpensemanagement.DbHelper.DbHelper dbHelper, GlobalVariableService globalValue, ModuleService.ModuleService moduleService)
        {
            _dbHelper = dbHelper;
