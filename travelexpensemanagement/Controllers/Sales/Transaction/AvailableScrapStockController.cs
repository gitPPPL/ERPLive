...
namespace travelexpensemanagement.Controllers.Sales.Transaction
{
    public class AvailableScrapStockController : Controller
    {
        ...
        public AvailableScrapStockController(DataBaseConnection dbcontext, DbHelper dbHelper, GlobalVariableService globalValue, ModuleService.ModuleService moduleService, Services.IMasterDataService masterDataService)
        {
            _dbHelper = dbHelper;
