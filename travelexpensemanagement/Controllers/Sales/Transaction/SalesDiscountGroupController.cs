...
namespace travelexpensemanagement.Controllers.Sales.Transaction
{
    public class SalesDiscountGroupController : Controller
    {
        ...
        public SalesDiscountGroupController(DataBaseConnection dbcontext, travelexpensemanagement.DbHelper.DbHelper dbHelper, GlobalVariableService globalValue, ModuleService.ModuleService moduleService, Services.IMasterDataService masterDataService)
        {
            _dbHelper = dbHelper;
