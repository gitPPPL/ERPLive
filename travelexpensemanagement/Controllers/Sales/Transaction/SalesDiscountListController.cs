...
namespace travelexpensemanagement.Controllers.Sales.Transaction
{
    public class SalesDiscountListController : Controller
    {
        ...
        public SalesDiscountListController(DataBaseConnection dbcontext, DbHelper dbHelper, GlobalVariableService globalValue, ModuleService.ModuleService moduleService)
        {
            _dbHelper = dbHelper;
