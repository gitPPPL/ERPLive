...
namespace travelexpensemanagement.Controllers.Sales.Transaction
{
    public class AvailableScrapStockListController : Controller
    {
        ...
        public AvailableScrapStockListController(DataBaseConnection dbcontext, travelexpensemanagement.DbHelper.DbHelper dbHelper, GlobalVariableService globalValue, ModuleService.ModuleService moduleService)
        {
            _dbHelper = dbHelper;
