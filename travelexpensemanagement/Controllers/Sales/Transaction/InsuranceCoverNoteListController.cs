...
namespace travelexpensemanagement.Controllers.Sales.Transaction
{
    public class InsuranceCoverNoteListController : Controller
    {
        ...
        public InsuranceCoverNoteListController(DataBaseConnection dbcontext, DbHelper dbHelper, GlobalVariableService globalValue, ModuleService.ModuleService moduleService)
        {
            _dbHelper = dbHelper;
