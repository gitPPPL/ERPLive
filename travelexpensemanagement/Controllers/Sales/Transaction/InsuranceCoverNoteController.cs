...
namespace travelexpensemanagement.Controllers.Sales.Transaction
{
    public class InsuranceCoverNoteController : Controller
    {
        ...
        public InsuranceCoverNoteController(DataBaseConnection dbcontext, travelexpensemanagement.DbHelper.DbHelper dbHelper, GlobalVariableService globalValue, ModuleService.ModuleService moduleService, Services.IMasterDataService masterDataService)
        {
            _dbHelper = dbHelper;
