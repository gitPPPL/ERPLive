...
namespace travelexpensemanagement.Controllers.Sales.Transaction
{
    public class ScrapSaleSaudaListController : Controller
    {
        ...
        public ScrapSaleSaudaListController(DataBaseConnection dbcontext, travelexpensemanagement.DbHelper.DbHelper dbHelper, GlobalVariableService globalValue, ModuleService.ModuleService moduleService)
        {
            _dbHelper = dbHelper;
